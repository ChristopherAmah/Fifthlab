...
import kul1 from "../assets/smerp1.jpg";
import kul2 from "../assets/smerp2.jpg";
import kul3 from "../assets/smerp3.jpg";
import kul4 from "../assets/smerp4.jpg";
import kul5 from "../assets/smerp5.jpg";

const sections = [
  {
    title: "Reward & loyalty program",
    text: "Condition-based perks and rewards that will automatically be assigned to customers",
    img: kul1,
  },
  {
    title: "Automated order management",
    text: "Automating each stage of the order work-flow from start to fulfillment.",
    img: kul2,
  },
  {
    title: "Inventory Management",
    text: "Structure, manage and keep track of inventory items reliably and efficiently.",
    img: kul3,
  },
  {
    title: "Accounting Management",
    text: "Track and manage expenditures, credits, revenues and profits with SMERP",
    img: kul4,
  },
  {
    title: "Customer Management",
    text: "Intelligently and efficiently manage leads, opportunities and much more from your customers.",
    img: kul5,
  },
];
...
const KuleanPayScroll = () => {
  ...
  // The function handleScroll has been removed entirely.
          ...
          <div className="relative">
            <div className="sticky top-24 space-y-6 md:space-y-10">
              <h1 className="text-2xl sm:text-3xl md:text-[42px] font-medium text-[#03045E] leading-snug md:leading-tight mb-6 md:mb-10">
                SMERP: Smart ERP for Businesses
              </h1>
