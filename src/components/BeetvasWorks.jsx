      ...
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row md:items-center md:justify-between gap-12 md:gap-16">
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <p className="text-[#767676] text-sm md:text-[16px] mt-2 md:mt-3 max-w-md">
            Get instant API access with your keys, documentation, and sandbox environment.
          </p>
        </div>
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <p className="text-[#767676] text-sm md:text-[16px] mt-2 md:mt-3 max-w-md md:max-w-xl">
            Run test transactions, review logs, and confirm your end-to-end integration.
          </p>
        </div>
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <p className="text-[#767676] text-sm md:text-[16px] mt-2 md:mt-3 max-w-md">
            Activate production access, monitor real-time performance, and start vending airtime/data at scale.
          </p>
        </div>
