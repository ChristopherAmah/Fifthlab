...
import kul1 from "../assets/beetvas1.jpg";
import kul2 from "../assets/beetvas2.jpg";
import kul3 from "../assets/beetvas3.jpg";
import kul4 from "../assets/beetvas4.jpg";

const sections = [
  {
    title: "Airtime & Data API Access for Your Business",
          ...
          <div className="relative">
            <div className="sticky top-24 space-y-6 md:space-y-10">
              <h1 className="text-2xl sm:text-3xl md:text-[42px] font-medium text-[#03045E] leading-snug md:leading-tight mb-6 md:mb-10">
                Brainstorm and define what to build next
              </h1>
