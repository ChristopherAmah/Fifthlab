      ...
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row md:items-center md:justify-between gap-12 md:gap-16">
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <p className="text-[#767676] text-sm md:text-[16px] mt-2 md:mt-3 max-w-md">
            Download the Kuleanpay app from Google Play Store or App Store.
            You can also create a free account on our web app.
          </p>
        </div>
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <p className="text-[#767676] text-sm md:text-[16px] mt-2 md:mt-3 max-w-md md:max-w-xl">
            Create an account by providing the relevant information and get
            registered to start making transactions fearlessly.
          </p>
        </div>
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <p className="text-[#767676] text-sm md:text-[16px] mt-2 md:mt-3 max-w-md">
            Create or join a transaction on Kuleanpay and sleep with your eyes
            closed, because what you pay for is what you get!
          </p>
        </div>
