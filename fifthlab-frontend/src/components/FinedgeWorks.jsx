      ...
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row md:items-center md:justify-between gap-12 md:gap-16">
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <p className="text-[#767676] text-sm md:text-[16px] mt-2 md:mt-3 max-w-md">
            Schedule a demo to get full understanding of the intricacies of the core banking application.
          </p>
        </div>
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <p className="text-[#767676] text-sm md:text-[16px] mt-2 md:mt-3 max-w-md md:max-w-xl">
            Provide relevant information about financial institution such as name, type and interested features.
          </p>
        </div>
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <p className="text-[#767676] text-sm md:text-[16px] mt-2 md:mt-3 max-w-md">
            Integration into the finedge core banking application.
          </p>
        </div>
