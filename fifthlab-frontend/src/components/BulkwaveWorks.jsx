      ...
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row md:items-center md:justify-between gap-12 md:gap-16">
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <p className="text-[#767676] text-sm md:text-[16px] mt-2 md:mt-3 max-w-md">
            Create an account on <a href="" className="underline">Bulkwave.ng</a> to get started.
          </p>
        </div>
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <p className="text-[#767676] text-sm md:text-[16px] mt-2 md:mt-3 max-w-md md:max-w-xl">
            Complete your KYC verification and top up your wallet to activate airtime, data, and messaging services.
          </p>
        </div>
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <p className="text-[#767676] text-sm md:text-[16px] mt-2 md:mt-3 max-w-md">
            Send bulk airtime, data, and SMS to customers, staff, friends, or family, quickly and seamlessly.
          </p>
        </div>
