...
const KuleanPaySection = () => {
  return (
    <div className="py-8 md:py-16 px-4 sm:px-6 lg:px-[174.5px]">
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-8 md:gap-10 lg:gap-[40.65px] justify-between">

        {/* --- Text Content Section --- */}
        <div className="lg:w-1/2 text-center lg:text-left flex flex-col items-center lg:items-start">
          
          {/* Logo/Brand */}
          <div className="flex items-center justify-center lg:justify-start gap-3 bg-[#F1F2FF] px-4 py-2 rounded-full w-fit mb-3 sm:mb-3">
