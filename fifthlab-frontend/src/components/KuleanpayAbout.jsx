...
const KuleanPayScroll = () => {
  ...
  // *** REMOVED: Scroll sync logic (handleScroll) ***
    ...
    <section className="w-full py-10">
      {!isMobile ? (
        <div
          ...
          // *** MODIFIED: Set a normal height instead of scroll-triggering height ***
          // Previously: style={{ minHeight: `${sections.length * 100}vh` }}
              ...
              <div className="flex flex-col space-y-6 md:space-y-10">
                {sections.map((sec, idx) => (
                  <div
                    ...
                    onClick={() => setCurrentIndex(idx)} // This click functionality is kept
                  >
                    {/* Highlight Bar */}
                    <div
